...
window = Tk()
window.title("currency_converter by chiefbaki")
...
combobox4_1["values"] = ("02.08.2023 - 08.08.2023", "25.09.2023 - 01.09.2023", "18.10.2023 - 24.10.2023")
combobox4_1.grid(row=1, column=2,padx=20)
...
combobox4_4["values"] = ("2023", "2022", "2021")
